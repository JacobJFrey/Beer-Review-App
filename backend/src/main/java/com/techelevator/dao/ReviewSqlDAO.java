...
public class ReviewSqlDAO implements ReviewDAO {
	...
	public Review createReview(Review newReview) {
	        String insertReview = "INSERT into reviews (review_id, beer_id, author, title, stars, body) "
	        					+ "values(?,?,?,?,?,?)";
	        newReview.setId(getNextId());
	        		jdbcTemplate.update(insertReview, newReview.getId(), newReview.getBeerId(), newReview.getAuthor(), newReview.getTitle(), newReview.getReviewStars(), newReview.getReviewBody());
	        return newReview;
	}
