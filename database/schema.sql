...
INSERT INTO breweries (brewery_name,contact_info,address,website,phone,history,isOpen,open_time,close_time) VALUES ('Howl at the Moon Saloon','Howling Mad Murdock','667 Gravestone Avenue','www.moonhowl.com','666-666-6066','We offer the ambiance of a true graveyard because we''re built on one',true,'23:00','8:00');
INSERT INTO breweries (brewery_name,contact_info,address,city,state_abv,history,isOpen,open_time,close_time) VALUES ('Backend Brewery','Stateless Steve','8080 Springboot Str','Springfield','IL','It is magic we''re even open',false,'12:34','5:36');
INSERT INTO breweries (brewery_name,contact_info,address,website,phone,history,isOpen,open_time,close_time) VALUES ('The Vue','DJ Vue-X','404 Axios Avenue','www.dollarstore.org','123-456-8080','We released in Febrewary 2014',true,'9:54','20:21');
INSERT INTO breweries (brewery_name,contact_info,phone,website,email,address,city,state_abv,zipcode,history,isOpen,open_time,close_time) VALUES ('Brew Gentlemen','Mr. G. Brewman','412-871-5075','www.brewgentlemen.com','info@brewgentlemen.com','512 Braddock Ave.','Braddock','PA','15104','Brew Gentlemen aims to create soft, balanced and elegant beers and meaningful experiences while helping revitalize the historic steel town of Braddock, Pennsylvania.',true,'15:00','19:00');
INSERT INTO breweries (brewery_name,contact_info,address,city,state_abv,zipcode,history,isOpen,open_time,close_time) VALUES ('Voodoo Brewery','voodoobrewery.com','205 E. 9th Avenue','Homestead','PA','15120','Mardi Gras for your mouth.',true,'16:00','22:00');
INSERT INTO breweries (brewery_name,website,address,city,state_abv,zipcode,history,isOpen) VALUES ('Weyerbacher Brewing Co.','weyerbacher.com','905-G Line Street','Easton','PA','18042','This is a place we call home. Some call it Homestead.',true);
INSERT INTO breweries (brewery_name,website,address,history,isOpen) VALUES ('Brent''s Beers','www.ogbrent.com','235 Oak Hill Dr Pittsburgh, PA, 15239','Brent''s Beers embodies bodacious bouquets and bodes the best imbibable brews in the ''burg',true);
...
INSERT INTO reviews (beer_id, title, stars, body, author) VALUES (7, 'Drank this over Easter', 4, 'Man, dis beer like the Easter Bunny. Its full of hops.','Barry the Beefsquatch');
